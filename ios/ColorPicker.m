...
@interface ColorPickerModule() <UIColorPickerViewControllerDelegate>
...
@implementation ColorPickerModule
...
RCT_EXPORT_METHOD(registerDevMenu)
{
  ...
  // Register with the dev menu
  [ColorPickerDevMenu registerWithDevMenu:devMenu];
  #endif
}
